       ...
       hover:border-gray-300 hover:bg-white/50"
        >
          <p className="text-sm font-semibold text-gray-700">
            Jacobo es ahora Publico ¡¡
          </p>
        </div>
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
          Chatea con tu <span className="text-blue-600">documentos</span> en
          segundos.
        </h1>
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          Quill te permite tener conversaciones con cualquier documento
          PDF.Simplemente cargue su archivo y comience a hacer preguntas de
          inmediato
        </p>
        <Link
        ...
        <div className="relative isolate">
          ...
          >
            <div
             ...
             -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem]"
            />
          </div>
        </div>
      </div>
